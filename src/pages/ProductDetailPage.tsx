        ...
        <div className="flex flex-col md:flex-row gap-8 lg:gap-16">
          <div className="w-full md:w-1/2 flex flex-col gap-4">
            <div className="aspect-[3/4] rounded-xl overflow-hidden bg-brand-neutral1">
              <img src={product.imageMain} alt={product.name} className="w-full h-full object-cover" />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="aspect-[3/4] rounded-xl overflow-hidden bg-brand-neutral1">
                <img src={product.imageMain} alt={`${product.name} view 1`} className="w-full h-full object-cover" />
              </div>
              <div className="aspect-[3/4] rounded-xl overflow-hidden bg-brand-neutral1">
                <img src={product.imageHover} alt={`${product.name} view 2`} className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 flex flex-col">
            ...
            <div className="mb-8">
              ...
              <div className="flex gap-3">
                ...
                <button onClick={() => setSelectedColor('Cream')} className={`w-8 h-8 rounded-full border-2 ${selectedColor === 'Cream' ? 'border-brand-dark' : 'border-transparent'} flex items-center justify-center p-0.5`}>
            ...
            <div className="mb-8">
              ...
              <div className="inline-flex items-center border border-gray-200 rounded-md">
                ...
                <button onClick={() => setQuantity(quantity + 1)} className="p-3 text-gray-500 hover:text-brand-dark transition-colors">
                  <Plus size={16} />
                </button>
              </div>
            </div>
