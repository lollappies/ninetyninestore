// src/components/OurPicksSection.tsx
  ...
  return (
    <section className="py-24 px-4 md:px-8 max-w-[1440px] mx-auto">
      ...
      >
        ...
        <button
          onClick={onBrowseAll}
          className="text-xs font-bold tracking-[0.15em] uppercase text-brand-dark border-b border-brand-dark pb-1 hover:text-brand-accent hover:border-brand-accent transition-colors self-start md:self-auto"
        >
          {t('section_view_all')}
        </button>
      </motion.div>
