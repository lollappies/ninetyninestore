          ...
          >
            ...
            <div className="flex-1 overflow-y-auto py-4">
              <a
                href="/sale"
                onClick={onClose}
                className="block px-6 py-4 text-[13px] tracking-[0.15em] uppercase text-brand-accent font-medium border-b border-gray-50"
              >
                {t('mobile_menu_sale')}
              </a>
                    ...
                    >
                      {categories.map((cat) => (
                        <a
                          ...
                          onClick={onClose}
                          className="block px-8 py-3 text-xs tracking-wider text-gray-600 hover:text-brand-dark"
                        >
                          {cat}
                        </a>
                      ))}
              ...
              <a
                href="#stores"
                onClick={onClose}
                className="block px-6 py-4 text-[13px] tracking-[0.15em] uppercase text-brand-dark border-b border-gray-50"
              >
